...
8. **Pockets list preview** — the **first row of that pocket’s details active list** (nearest dated active, else oldest no-date). Same 072 amounts / % / remaining / bar. No badge. No preview if there are no active goals.
