	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				destructive:
					'border-destructive/40 bg-destructive/10 text-destructive hover:bg-destructive/20 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/20 dark:hover:bg-destructive/30 focus-visible:border-destructive/40',
			...
			size: {
				...
				'icon-sm':
					'size-10 rounded-[min(var(--radius-md),10px)] md:size-8 in-data-[slot=button-group]:rounded-md',
