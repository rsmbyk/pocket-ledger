...
| UX                                   | **Desktop-first dashboard chrome**, responsive down to mobile (inset sidebar → sheet + stacked layouts below `sm`; other layouts still `md`). Session-unknown boot is a spinner (221); the shell keeps nav/header and shows destination-shaped skeletons until the ledger is ready (245).                                                                                                                                                                  |
