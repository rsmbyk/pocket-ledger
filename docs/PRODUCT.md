...
| Plans                                | Confirm-before-ledger reminders (not money until accept-mode Save). Nav **Plans** at `/plans`. Home shows a 1-week window card; pocket details lists that pocket’s Plans; Repeat Once / Weekly / Monthly (specs 223–224). Desktop sidebar collapses to an icon rail (226). |
