...
| Desktop shell                        | No Tauri; desktop-first dashboard shell (inset sidebar + KPI home + wide stage, spec 013). On xl, Home is two equal scrolling columns (238); pocket details is three (235); Transactions/Plans filters are a content-sized right card beside chrome+list (234) with a Filters title and even header/footer padding (240). |
