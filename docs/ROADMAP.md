...
No numbered slice is queued. The next spec ID is **251**.
...
11. ~~**Remove temporary debug** — fake signup and reset-cloud off production~~ → `specs/250-remove-temporary-debug/`

## Shipped — after cloud (123–249)

Catalog overlay, visual system, Transactions and Settings hubs, GIS polish, Plans, pocket budgets, and dashboard chrome. Latest behavior before 250 is Spec 249 (budget unique-scope form UX). Full index: `specs/README.md`.
